...
const leads = [
  ...
  // --- critical: overdue + tier1 + SUV ------------------------------------
  {
    ...
    qualified_at: hoursAgo(3), city_tier: "tier1",
  ...
  },
  {
    ...
    qualified_at: hoursAgo(8), city_tier: "tier2",
  ...
  },
  {
    ...
    qualified_at: hoursAgo(5), city_tier: "tier1",
    contact_phone_available: true, contact_email_available: true,
    contact_attempts: 0, last_contact_attempt_at: null,
  ...
  // --- high: overdue, standard segment ------------------------------------
  {
    ...
    qualified_at: hoursAgo(26), city_tier: "tier2",
    contact_phone_available: true, contact_email_available: true,
    contact_attempts: 0, last_contact_attempt_at: null,
    customer_type: "new", test_drive_requested: false, notes: []
  },
  {
    ...
    qualified_at: hoursAgo(9), city_tier: "tier1",
    contact_phone_available: true, contact_email_available: false,
    contact_attempts: 0, last_contact_attempt_at: null,
    customer_type: "new", test_drive_requested: false, notes: []
  },
  {
    ...
    qualified_at: hoursAgo(25), city_tier: "tier3",
    contact_phone_available: true, contact_email_available: true,
    contact_attempts: 0, last_contact_attempt_at: null,
    customer_type: "new", test_drive_requested: false, notes: []
  },
  ...
  // --- nurture: repeated attempts, no engagement --------------------------
  {
    ...
    qualified_at: hoursAgo(96), city_tier: "tier2",
    contact_phone_available: true, contact_email_available: true,
    contact_attempts: 2, last_contact_attempt_at: hoursAgo(40),
  ...
  },
  {
    ...
    qualified_at: hoursAgo(130), city_tier: "tier3",
    contact_phone_available: true, contact_email_available: true,
    contact_attempts: 3, last_contact_attempt_at: hoursAgo(50),
    customer_type: "new", test_drive_requested: false,
  ...
  },
  {
    ...
    qualified_at: hoursAgo(110), city_tier: "tier1",
    contact_phone_available: true, contact_email_available: true,
    contact_attempts: 2, last_contact_attempt_at: hoursAgo(35),
    customer_type: "new", test_drive_requested: false,
